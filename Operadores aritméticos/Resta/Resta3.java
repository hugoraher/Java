...
/**
 * Nombre del programa: Resta 3.
 * ---
 * "El programa resta de cinco números.
 ...
 * Hora última de modificación: 14:41 pm
 *
 */

public class Resta3 {             //Se inicia la clase
    public static void main (String [] args){
        ...
        System.out.print("Ingresa el cuarto número: "); //Sengundo mensaje de impresión para ingresar datos por teclado.
        n4=input.nextInt();                             //Lee los datos que ingresa por teclado.
        
        System.out.print("Ingresa el quinto número: "); //Sengundo mensaje de impresión para ingresar datos por teclado.
